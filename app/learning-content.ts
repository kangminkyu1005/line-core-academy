...
export const glossaryTopics: GlossaryTopic[] = [
  ...
  },
  {
    ...
    examples:["검정값이 20이고 흰색값이 80이면 TARGET = (20 + 80) / 2 = 50입니다.","함수를 호출할 때 TARGET을 전달하면 함수 안의 소문자 매개변수 target이 이 값을 받아 사용합니다."],
  ...
  },
  {
    ...
    formulas:["def line_follow(base_speed, target, kp, kd):","    previous_error = 0","line_follow(BASE_SPEED, TARGET, KP, KD)"],
...
export const finalQuizQuestions: FinalQuizQuestion[] = [
  ...
  {category:"센서와 기준",question:"BASE_SPEED가 의미하는 값은 무엇일까요?",options:["함수에 전달할 기본 모터 속도 설정값","검정 바닥의 반사광","직전 반복의 오차","최종 보정값"],answer:0,explanation:"BASE_SPEED는 함수 밖에서 준비하고, 호출할 때 소문자 매개변수 base_speed로 전달됩니다.",glossaryId:"variable"},
  ...
  {category:"센서와 기준",question:"검정과 흰색의 전역 경계 설정값을 선언하는 올바른 코드는 무엇일까요?",options:["TARGET = (BLACK_VALUE + WHITE_VALUE) / 2","TARGET = BLACK_VALUE - WHITE_VALUE","TARGET = WHITE_VALUE * 2","TARGET = sensor_value + error"],answer:0,explanation:"함수 밖의 경계 설정값 TARGET은 두 반사광 설정값의 평균으로 구합니다.",glossaryId:"target"},
  {category:"센서와 기준",question:"BLACK_VALUE가 20, WHITE_VALUE가 80이라면 TARGET은 얼마일까요?",options:["20","80","50","100"],answer:2,explanation:"(20 + 80) / 2 = 50입니다.",glossaryId:"target"},
